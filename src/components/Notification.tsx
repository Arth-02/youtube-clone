...
interface NotificationItemProps {
  id: number;
  hoveredNotification: number | null;
  setHoveredNotification: (id: number) => void;
}

const NotificationItem: React.FC<NotificationItemProps> = ({ id, hoveredNotification, setHoveredNotification}) => {
  return (
    <div
    ...
    >
      ...
      <div className={`${hoveredNotification === id ? "opacity-100" : "opacity-0"} pr-4`}>
        <DropdownMenuSub>
          <DropdownMenuSubTrigger>
            <MenuIcon />
          </DropdownMenuSubTrigger>
          <DropdownMenuPortal>
            <DropdownMenuSubContent >
              <DropdownMenuItem>
                <DropdownMenuLabel>Hide this notification</DropdownMenuLabel>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem>
                <DropdownMenuLabel>Turn off all from ABC</DropdownMenuLabel>
              </DropdownMenuItem>
            </DropdownMenuSubContent>
          </DropdownMenuPortal>
        </DropdownMenuSub>
