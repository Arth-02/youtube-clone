...
const Header = () => {
  const { handleSidebar, slideSidebar, permanentCollapse } = useContext(SidebarContext);
            ...
            : status === "authenticated" ? (
              <>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="min-w-fit md:min-w-fit" side="bottom" align="end">
                    <DropdownMenuItem>
              ...
              <Link href="/login" className="p-2 border border-black rounded-lg">
                Login
              </Link>
            )}
          </div>
